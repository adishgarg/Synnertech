...
const problemStatements = [
    {
      ...
      features: ["Easy connecting features", "Categorized approach", "Campus life management section", "Mental health management"]
    },
    {
      heading: "Online Education Platform",
      content: "Due to post covid effects on study you being an educational institute finds a need to develop an online platform for education delivery aiming to provide an innovative experience to students and track their progress.",
      hyperlinkName: "Design Templates",
      link: "https://www.figma.com/design/msZVWACKOitLFvo4nAk71O/SYNER-TECH-Final-templates?node-id=1-2&p=f&t=sF6HaOaC4pGXzLND-0",
      features: ["Interactive elements", "Dedicated profile for progress tracking", "Calendar-oriented planning", "Burden free approach"]
    },
    {
      heading: "Financial Literacy Scale",
      content: "Financial literacy is one of the most valuable skills for individuals in every era. The need for a constant monitoring system and timely feedback is key to achieving literacy in any field. As a financial consulting firm, develop a tool encompassing all major aspects.",
      hyperlinkName: "Design Templates",
      link: "https://www.figma.com/design/msZVWACKOitLFvo4nAk71O/SYNER-TECH-Final-templates?node-id=1-480&p=f&t=sF6HaOaC4pGXzLND-0",
      features: ["Literacy scale for gauging momentary levels of literacy", "Content curation tool", "Feedback system for accurate diagnosis and solution of problems", "News and industry tracker"]
    },
    {
      heading: "Cloud Gaming Service",
      content: "Being an aspiring gamer and restricted by personal computer hardware is one of the worst nightmares. To tackle this problem, develop a cloud gaming service that allows users to run high-end games and manage different game profiles for a better experience.",
      hyperlinkName: "Design Templates",
      link: "https://www.figma.com/design/msZVWACKOitLFvo4nAk71O/SYNER-TECH-Final-templates?node-id=1-481&p=f&t=sF6HaOaC4pGXzLND-0",
      features: ["Dedicated game information", "Advanced Game Management", "Game Recommendations", "Game Community"]
    }
  ];
  
  export default function ProblemAllocator() {
    const [teamId, setTeamId] = useState<string | null>("");
    const [allocatedProblem, setAllocatedProblem] = useState<typeof problemStatements[0] | null>(null);
